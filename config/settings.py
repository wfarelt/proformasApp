...
CLOUD_CATALOG_GIT_AUTOPUBLISH = config('CLOUD_CATALOG_GIT_AUTOPUBLISH', default=True, cast=bool)
CLOUD_CATALOG_GIT_BRANCH = config('CLOUD_CATALOG_GIT_BRANCH', default='master')
