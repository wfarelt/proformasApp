...
urlpatterns = [
    ...
    path('config/empresas/', superadmin_company_list, name='superadmin_company_list'),
    path('config/empresas/<int:company_id>/editar/', superadmin_company_edit, name='superadmin_company_edit'),
    ...
    path('proforma/<int:id>/copiar/', copiar_proforma, name='copiar_proforma'),
